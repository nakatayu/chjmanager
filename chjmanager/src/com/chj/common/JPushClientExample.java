...
public class JPushClientExample {
	...
	private static final String appKey ="d2abf724a3a0e72ed4f990ee";	//必填，例如466f7032ac604e02fb7bda89

	private static final String masterSecret = "47645cbbeb5bb88d0a0ad3b5";//"13ac09b17715bd117163d8a1";//必填，每个应用都对应一个masterSecret
	...
	private static void testSend() {
		...
		MessageResult msgResult = jpush.sendNotificationWithAlias(sendNo, "test1", msgTitle, msgContent);
		//覆盖指定msgId的消息,msgId可以从msgResult.getMsgid()获取。overriceMsgId
