	...
	<div id="content">
		<div id="content-header">
			<div id="breadcrumb">
				...
				</a> <a href="javascript:void(0)" onclick="window.history.go(-1)"
					title="共享漕河泾列表" class="current"><i class="icon-key"></i>
					共享漕河泾列表</a> <a href="#" class="current">新增共享漕河泾信息</a>
			</div>
		</div>
						...
						<form id="formDivId" class="form-horizontal">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input id="phone" type="text" name="phone"
															style="width: 250px;" onblur="phoneOnBlur()" /> <span><font
												...
												<div class="control-group">
													...
													<div class="controls">
														<textarea id="summary" name="summary"
															...
															style="width: 250px; height: 80px; overflow: auto;"></textarea>
								...
								<div id="form-wizard-1" class="step">
									...
									<div class="controls" style="height: 300px; width: 800px">
										<textarea style="height: 300px; width: 800px"
											name="content" id="serviceContentId"></textarea>
								...
								<div class="control-group" style="height: 68px;">
									...
									<input name="thirdCategoryTag" id="thirdCategoryTag"
										type="hidden">
									<div class="controls" id="selectLabel" style="font-size:20px;height: 30px;"></div>
								</div>
