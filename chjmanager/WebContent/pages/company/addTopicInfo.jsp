		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="../index.jsp" title="主页" class="tip-bottom"><i
					class="icon-home"></i> 主页</a> <a href="./TopicList.jsp" title="发表话题"
					...
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form class="form-horizontal" method="post"
								action="${ctx}/topic!seveTopic.action" name="basic_validate"
											...
											<div id="form-wizard-1" class="step">
												...
												<div class="controls">
													<input id="topicName" name="topicName" type="text"
														style="width: 254px;" onblur="topicOnBlur()" /> <span><font
									...
									<div class="control-group">
										...
										<div class="controls">
											<input id=TopicAbstract type="text" name="TopicAbstract"
												style="width: 250px;" onblur="TopicAbstractOnBlur()" /> <span><font
						...
						<div class="form-actions">
							<button class="btn btn-warning" type="button"
								class="btn btn-success" onclick="saveTopicInfo()">保&nbsp;&nbsp;&nbsp;&nbsp;存</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="btn btn-warning" type="button"
					...
					success : function(msg, status) {
						if (msg.status == 200) {
							...
							for ( var i = 0; i < msg.rows.length; i++) {
								array.push('<li class="tag_content"	onclick="tagname(this)" onmouseover="this.id=\'a1\' " onmouseout="this.id=\'this\'"');
				...
				.ajax({
					...
					success : function(msg, status) {
						if (msg.status == 200) {
							var array = [];
							for ( var i = 0; i < msg.rows.length; i++) {
								array.push('<li class="tag_content"	onclick="commonalityclassifyvalue(this)" onmouseover="this.id=\'a1\' " onmouseout="this.id=\'this\'"');
								array.push('	 value="'+ msg.rows[i]["productCategoryId"]+ '">' + msg.rows[i]["Name"] + '</li>')
							}
				...
				if (msg.status == 200) {
					...
					for ( var i = 0; i < msg.rows.length; i++) {
						...
						$("#detailedAddress").data(
								"'" + msg.rows[i]["areaId"] + "'",
								msg.rows[i]["detailedAddress"] + "#"+ msg.rows[i]["lat"] + "#"+ msg.rows[i]["lng"])
					}
					$('#lat').html(array.join(''))
					$('#lng').html(array.join(''));
