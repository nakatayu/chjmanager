				...
				<div class="widget-box" style="margin-bottom: 0px;">
					<div align="left" class="widget-title">
						<input style="margin: 3px 0px 2px 5px" align="right" type="text"
							id="txtName" placeholder="请输入商品名称" onblur="loadData(1)">
					...
					<div class="widget-title"
						...
						<div class="pagination alternate"
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="btn btn-warning" onclick="deleteshop()">删除商品</button>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
							...
							for ( var i = 0; i < msg.rows.length; i++) {
								...
								array
										.push('<td>'
												...
												+ ')">' + data["factory"]
												+ '</td>');
								var ddd = removeHTMLTag(data["content"]);
								array
										.push('<td>'
												+ '<a href="javascript:void(0)" onclick="updateShopInfo('
												+ msg.rows[i]["product_id"]
												+ ')">' +(ddd.length>80?ddd.substr(0,80)+'...':ddd)
												+ '</td>');
								/* array.push('<td>'
												+ '<a href="javascript:void(0)" onclick="updateShopInfo('
												+ msg.rows[i]["product_id"]
	...
	function addProductInfo() {
		location.href = "${ctx}/pages/company/ProductMaintainAdd.jsp";
	}
