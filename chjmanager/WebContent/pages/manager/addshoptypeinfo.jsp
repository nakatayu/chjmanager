		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="../index.jsp" title="主页" class="tip-bottom"><i
					class="icon-home"></i> 主页</a> <a href="./ShopType.jsp" title="店铺类型维护"
					class="tip-bottom"><i class="icon-home"></i>店铺类型维护</a> <a href="#"
					class="current">创建店铺类型</a>
			</div>
		</div>
						...
						<form class="form-horizontal" id="basic_validate">
								...
								<tr>
									<td>
										<div id="form-wizard-1" class="step">
											<label class="control-label">店铺类型名称：</label>
											<div class="controls">
							...
							<div class="form-actions">
								<button class="btn btn-warning" type="button"
									class="btn btn-success" onclick="addShopType()">确认保存</button>
							</div>
		...
		if (flag != false) {
			...
			$
					.ajax({
						type : "post",
						data : data,
						url : '${ctx}/company!seveShopType.action',
						dataType : 'json',
						success : function(msg, status) {
							if (msg.status == 200) {
								alert("保存成功！");
								window.location.href = "${ctx}/pages/manager/ShopType.jsp";
