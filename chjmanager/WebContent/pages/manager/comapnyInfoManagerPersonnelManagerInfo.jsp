		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="${ctx}/pages/index.jsp" title="主页" class="tip-bottom"><i
					...
					href="${ctx}/pages/manager/comapnyInfoManagerPersonnelManagerList.jsp"
					class="current"><i class=" icon-edit"></i>开发区人员账号管理列表</a> <a
					href="#" class="current">新增开发区人员账号</a>
			</div>
		</div>
					...
					<div class="widget-box">
						...
						<form class="widget-content nopadding" id="formDivId">
							...
							<div class="form-actions">
								<a class="btn btn-warning" style="margin: 10px 100px;"
									onclick="savePersonnel()">确认保存</a>
								<a class="btn btn-warning" style="margin: 10px 100px;"
...
<script type="text/javascript">
	...
	function savePersonnel() {
		...
		if (flag != false) {
			...
			$.ajax({
				type : "post",
				url : '${ctx}/personnel!newManagerPersonnelInfo.action',
				dataType : 'json',
				data : data,
				timeout : 10000,
				success : function(msg, status) {
