		...
		<div style="margin-right: 40px; border: none;">
			<div class="form-horizontal" style="width: 60%; float: left;">
				<div class="control-group">
					...
					<div class="controls" style="width: 484px;">
						<select style="width: 484px;" id="firstExtend" name="firstList">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="pictureTitle" name="pictureTitle" type="text"
							onblur="pictureTitleOnBlur()" style="width: 474px;" /> <span><font
							color="red" id="pictureTitle_check"> </font></span>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea id="linkAddress" name="linkAddress" 
							style="width: 474px;height: 150px;overflow: hidden;" ></textarea> 
				...
				<div class="control-group">
					<button class="btn btn-warning" style="margin: 40px 0 30px 150px;"
						class="btn btn-success" onclick="saveAdvertiSementIn()">保&nbsp;&nbsp;&nbsp;&nbsp;存</button>
				</div>
			</div>
			<div style="width: 30%; margin: 10px 0 0 0; float: left;">
				<div style="text-align: center;padding: 0 0 0 60px;">
					...
					<input type="hidden" id="pictureAddress" name="pictureAddress">
				</div>
				<div style="padding: 30px 0 0 60px;text-align: center;">
					<a id="uploadButton" class="btn btn-primary">浏&nbsp;&nbsp;&nbsp;&nbsp;览</a> <br />
					<font color="red">(上传尺寸：320*160px 限制上传：150KB )</font>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function linkAddressOnBlur() {
		var likAddress = $.trim($("#linkAddress").val());
		if (likAddress.length > 200) {
			$("#linkAddress_check").html("长度不能超过200个字符!");
			return;
		} else {
			$("#linkAddress_check").html("");
		}
	}
	...
	function saveAdvertiSementIn() {
		...
		$.ajax({
			type : "post",
			url : '${ctx}/advertisement!insertAdvertiSementInfo.action',
			dataType : 'json',
			data : data,
