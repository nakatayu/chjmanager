						...
						<div class="widget-content nopadding">
							<h5 id="upcl">
								...
								<button id="uploadButton" class="btn btn-primary"
									...
									<%-- 
									<img alt="style="margin-left:20px;"  width="100" height="100" id="loadTImgeid"
									 src="${http_img }${}"> --%>
							</h5>
							<div
										...
										<td>
											<div class="control-group">
												...
												<div class="controls">
													<table>
														<tr>
															<td width="170"><label> <input
																	type="radio" id="checkbox" name="checkbox" value="T" checked="checked"/>是否审核（是）
															</label></td>
															<td><label> <input type="radio"
																	id="checkbox" name="checkbox" value="F" />是否审核（否）
															</label></td>
														</tr>
													</table>
												</div>
		...
		new AjaxUpload($uploadBtn,
				{
					...
					name : 'upfile',
					responseType : 'json',
					data:{type:3},//个人头像1企业所有图片2店铺所有图片3圈子图片4话题图片5活动图片6商品图片7广告图片8个人证件图片9二维码图片10其他图片11
					...
					onComplete : function(file, response) {
						if (response.status == 200) {
							...
							$("#loadTImgeid").attr("src","${http_img}" + response.rows);
