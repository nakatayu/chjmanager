		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="${ctx}/pages/index.jsp" title="主页" class="tip-bottom"><i
					class="icon-home"></i> 主页</a> <a href="${ctx}/pages/manager/ShopType.jsp" title="店铺类型维护"
					...
					<div class="widget-box">
						...
						<div class="form-actions">
							<button class="btn btn-warning" type="button"
								class="btn btn-success" onclick="addShopType()">确认修改</button>
						</div>
			...
			if(flag != false){
				var	data = $("#basic_validate").serialize(); 
				 $.ajax({
					type : "post",
					data :data,
					url : '${ctx}/company!updateShopTypeInfo.action',
					dataType : 'json',
