	...
	<div id="content">
		<div id="content-header">
			...
			<a href="${ctx}/pages/index.jsp" title="主页" class="tip-bottom"><i
				 ...
				 <a  href="javascript:void(0)"  onclick="shopList()" class="current"><i class=" icon-repeat"></i>店铺列表</a>
				<a href="javascript:void(0)"  onclick="orderList()" class="current"> <i class="  icon-pencil"></i>订单列表</a>
...
var orderItemId = <%=request.getParameter("orderItemId")%>;
	...
	PageClick = function(pageclickednumber) {
	    ...
	    loadData(pageclickednumber);
			...
			//  返回订单列表页面 
			function orderList(companyShopId){
				location.href = "${ctx}/pages/manager/companyInfoManagerOrderList.jsp?&companyId="+companyId+"&companyShopId="+<%=request.getParameter("companyShopId")%>;
			}
			//打印订单 
