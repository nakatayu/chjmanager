	...
	<div id="content">
		<div id="content-header">
			<div id="breadcrumb">
				...
				<i class="icon-home"></i> 主页</a> <a href="#" class="current">活动评论维护</a>
			</div>
		</div>
...
<td align="left" style="font-size: 20px;font-weight: bold;">活动评论列表：</td>  
...
function updatCommentDelete(){
	...
	$.ajax({
		type : "post",
		url : '${ctx}/activity!updatActivCommentlete.action',
		dataType : 'json',
		data : {activCommId:str,activityId:'${param.activityId}'},
...
function loadData(page) {
	 pagenumber=page;
	 pageinfo["activityId"]="${param.activityId}";
	 ...
	 pageinfo["page"]=page;
	  ...
	  $.ajax({
		type : "post",
		url : '${ctx}/activity!findActivityCommentList.action',
		dataType : 'json',
		data : pageinfo,
		success : function(msg, status) {
			if(msg.status==200){
