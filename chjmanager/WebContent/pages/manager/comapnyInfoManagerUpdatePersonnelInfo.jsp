	...
	<div id="content" class="form-horizontal">
		<div id="content-header">
			<div id="breadcrumb">
				...
				</a> <a href="#" class="current">修改人员账号</a>
			</div>
		</div>
									...
									<table width="25%">
										<tr>
											<c:if test="${personnel.type==2||personnel.type==3}">
												<td><label id="company">企业 <c:if
															test="${personnel.type=='2'}">
												...
												<td><label id="shop"> 店铺 <c:if
														...
														</c:if> <span  style="margin-left: 20px;"><font color="red" id="personnelType_check">*必选
														</font></span>
												</label></td>
											</c:if>
											...
											<c:if test="${personnel.type==4||personnel.type==5}">
												...
												<td><label id="compangPersonnelId">企业 <c:if
															test="${personnel.type=='4'}">
												...
												<td><label id="shopPersonnelId"> 店铺 <c:if
															test="${personnel.type=='5'}">
														...
														</c:if> <span  style="margin-left: 20px;"><font color="red" id="xinbakeType_check">*必选
														</font></span>
												</label></td>
											</c:if>
										</tr>
