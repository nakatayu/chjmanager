																...
																<%-- 	<label class="control-label">活动名称：</label>
																	<div class="controls">
																		<input id="name" name="name" type="text"
																			style="width: 254px;" onblur="nameOnBlur()" value="${activity.activity_title}"/> <span><font
												...
												<div id="form-wizard-1" class="step">
															<div class="control-group">
																...
																<div class="controls">
																		...
																		style="width: 180px;" onblur="linkmanTelOnBlur()"  value="${activity.begin_time}"/> 
																		结束时间：	<input id="endTime" type="text" name="endTime"
																		style="width: 180px;" onblur="serviceTimeOnBlur()" value="${activity.end_time}"/>（格式：yyyy-MM-dd HH:mm:ss） <span><font
													...
													<div class="shop_announcement">
														...
														<div class="controls" style="height: 200px">
															<textarea type="text" name="content"
																...
																style="height: 150px" id="content11" value="${activity.activity_content}" ></textarea>
