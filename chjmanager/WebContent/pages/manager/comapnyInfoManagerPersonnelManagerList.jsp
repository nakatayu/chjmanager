		...
		<div id="breadcrumb">
			<a href="${ctx}/pages/index.jsp" title="主页" class="tip-bottom">
				<i class="icon-home"></i> 主页</a>
				 <a href="#" class="current">开发区人员账号管理列表</a>
		</div>
	</div>
				...
				<div class="widget-box">
					...
					<div class="widget-title"
						...
						<div class="row-fluid" style="margin: 6px 0px 0px 0px">
							<button class="btn btn-warning" onclick="addPersonnel()">新增管理员</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="btn btn-warning" onclick="delPersonnel()">删除管理员</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button class="btn btn-warning" onclick="setPernelManager()">管理员权限</button>
						</div>
					</div>
				</div>
			</div>
...
function loadData(page, size, name) {
	...
	$.ajax({
		type : "post",
		url : '${ctx}/personnel!findManagerPersonnelList.action',
		dataType : 'json',
		data : pageinfo,
...
function addPersonnel(){
	 location.href = "${ctx}/pages/manager/comapnyInfoManagerPersonnelManagerInfo.jsp";
}
//查询账号
function findPersonnel(personnelId){
	location.href = "${ctx}/personnel!findManagerPersonnelInfo.action?personnelId="+personnelId;
}
//删除账号
...
function setPernelManager(){
	...
	window.location.href='${ctx}/personnel!seltRoleOfPersonnel.action?personnelId='+lbl[0]+'&type='+0;	
}
